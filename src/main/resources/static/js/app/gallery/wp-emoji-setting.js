window._wpemojiSettings = {
    ...
    "svgExt": ".svg",
    "source": {"concatemoji": "http:\/\/www.pagesthink.com\/wp-includes\/js\/wp-emoji-release.min.js?ver=4.6.9"}
};
!function (a, b, c) {
    function d(a) {
        var c, d, e, f, g, h = b.createElement("canvas"), i = h.getContext && h.getContext("2d"),
