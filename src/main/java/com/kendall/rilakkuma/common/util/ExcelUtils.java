package com.kendall.rilakkuma.common.util;

import com.csvreader.CsvWriter;
import com.kendall.rilakkuma.common.annotation.ExportConfig;
import com.kendall.rilakkuma.common.handler.ExportHandler;
import com.kendall.rilakkuma.common.util.poi.convert.ExportConvert;
import com.kendall.rilakkuma.common.util.poi.pojo.ExportItem;
...
public class ExcelUtils {
    ...
    private void requiredbuilderParams() {
        if (mClass == null) {
            throw new IllegalArgumentException("请先使用com.kendall.rilakkuma.util.ExcelUtils.builder(Class<?>)构造器初始化参数。");
        }
    }
    ...
    private void requiredexportParams() {
        if (mClass == null || mResponse == null) {
            throw new IllegalArgumentException(
                    "请先使用com.kendall.rilakkuma.util.ExcelUtils.export(Class<?>, HttpServletResponse)构造器初始化参数。");
        }
